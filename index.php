...
<html>
    <head lang="hu">
        ...
        <link rel="shortcut icon" href="videos/images/play.png" type="image/x-icon">
        <meta name="description" content="Médialejázszó">
        <meta charset="UTF-8">
                ...
                <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6 p-2 m-auto">
                    <div class="br-4 border-1-solid-gray text-gray">
                        <div class="p-2 pt-2 mb-2">
                            ...
                            <video style="max-height: 406px;" poster="images/M_C_Logo_Type.png" id="music" preload="none" class="w-100 pt-2">
